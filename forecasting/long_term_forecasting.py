...
from data_management.database_format import db_long_term_forecasting,half_hourly_history_data
...
def long_term_forecasting_load_uac_history(*args):
    # Short term forecasting for non-critical AC load
    session = args[0]
    Target_Time = args[1]
...
def long_term_forecasting_load_udc_history(*args):
    # Short term forecasting for non-critical DC load
    session = args[0]
    Target_Time = args[1]
